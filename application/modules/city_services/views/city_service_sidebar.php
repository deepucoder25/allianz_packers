...
<aside class="service-sidebar">
    ...
    <div class="sidebar-widget widget-services mb-4 p-0 overflow-hidden">
        ...
        <div class="widget-services-header">
            ...
            <p class="widget-desc m-0">Expert shifting services in <?= $city ?>.</p>
        </div>
        ...
        <div class="widget-services-body">
            <ul class="sidebar-services-list" id="sidebarServiceList">
                <?php
                $sidebar_services = [
                    ['slug' => 'home-shifting-in-' . $ctlink,      'name' => "Home Shifting",          'icon' => 'bi-house-door-fill'],
                    ['slug' => 'office-shifting-in-' . $ctlink,    'name' => "Office Relocation",      'icon' => 'bi-building-fill'],
                    ['slug' => 'car-transport-in-' . $ctlink,      'name' => "Car Transportation",     'icon' => 'bi-car-front-fill'],
                    ['slug' => 'bike-transport-in-' . $ctlink,     'name' => "Bike Transportation",    'icon' => 'bi-bicycle'],
                ];
    ...
    <div class="sidebar-widget widget-trusted-badges">
        <div class="trusted-header d-flex align-items-start gap-2 mb-4">
            ...
            <div>
                <h4 class="trusted-title">Why Choose <?= $company3 ?> in <?= $city ?>?</h4>
        ...
        <ul class="trusted-timeline-list m-0 p-0">
            ...
            <li class="trusted-timeline-item d-flex align-items-center gap-3 position-relative mb-4">
                ...
                <div class="timeline-content text-start">
                    ...
                    <p class="timeline-item-desc">Families and businesses trust us in <?= $city ?></p>
                </div>
            </li>
