      ...
      <div class="row align-items-stretch">
        ...
        <div class="col-xl-7 d-flex flex-column justify-content-center text-col-wrap">
          ...
          <div class="hero-content-top text-center text-xl-start">
            <!-- Breadcrumbs -->
            <div class="mb-2">
              <nav class="slider-breadcrumb">
                <a href="<?= site_url() ?>"><i class="bi bi-house-door-fill me-1"></i>Home</a>
                <span class="bc-sep">/</span>
                <a href="<?= site_url('our-branches') ?>"><i class="bi bi-geo-fill me-1"></i>Branches</a>
                <span class="bc-sep">/</span>
                <span class="bc-text"><i class="bi bi-map-fill me-1"></i><?= $state ?></span>
                <span class="bc-sep">/</span>
                <span class="bc-text"><i class="bi bi-pin-map-fill me-1"></i><?= $city ?></span>
              </nav>
            </div>

            <div class="hero-badge-wrap mb-3">
              <span class="hero-badge shadow-sm">
                <span class="pulse-dot"></span> Best Packers & Movers in <?= $city ?>
              </span>
            </div>
            
            <h1 class="hero-title">
              WE MOVE YOUR WORLD
              IN <span class="text-brand-red"><?= strtoupper($city) ?> </span>WITH CARE
            </h1>
            
            <p class="hero-desc">
              From homes to offices, we provide end-to-end relocation solutions in <?= $city ?> that are safe, fast & hassle-free.
            </p>
            ...
            <div class="hero-value-icons my-4">
              <div class="value-icons-row-wrap d-flex justify-content-between align-items-start">
                ...
                <div class="value-item text-center">
                  ...
                  <span class="value-desc">Your belongings in <?= $city ?> are in safe hands</span>
                </div>
                ...
                <div class="value-item text-center">
                  ...
                  <span class="value-desc">Timely pickup and delivery in <?= $city ?></span>
                </div>
                ...
                <div class="value-item text-center">
                  ...
                  <span class="value-desc">High quality packing materials in <?= $city ?></span>
                </div>
                ...
                <div class="value-item text-center">
                  ...
                  <span class="value-desc">Best relocation solutions at competitive prices in <?= $city ?></span>
                </div>
