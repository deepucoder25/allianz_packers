    ...
    <div class="container my-4">
        <div class="row">
            ...
            <div class="col-lg-5 d-flex flex-column gap-3 contact-cards-stack">
                ...
                <!-- Box 1: Head Office Address -->
                <div class="contact-card-unique">
                    <div class="contact-icon-unique">
                        <i class="bi bi-geo-alt-fill"></i>
                    </div>
                    <div class="contact-box-content">
                        <h5 class="contact-card-title">Head Office Address</h5>
                        <p class="contact-card-text">Plot No- 44A, B Block, Near Old Shiv Mandir, Rangpur, Mahipalpur, New Delhi 110037, India</p>
                    </div>
                </div>
